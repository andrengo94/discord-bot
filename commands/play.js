...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand => {
            subcommand
                .setName("playlist")
                .setDescription("Plays YouTube playlist")
                .addStringOption(option => {
                    option
                        .setName("url")
    ...
    execute: async ({client, interaction}) => {
        if (!interaction.member.voice.channel) {
            await interaction.reply("You must be in a voice channel so I can play your music!");
            return;
        }
        ...
        if (interaction.options.getSubcommand() === "song") {
            ...
            const result = await client.player.search(url, {
                ...
                searchEnginer: QueryType.YOUTUBE_VIDEO,
            });
            ...
            const result = await client.player.search(url, {
                requestedBy: interaction.user,
                searchEnginer: QueryType.YOUTUBE_PLAYLIST,
            });
